...
namespace Blueshift.EntityFrameworkCore.Metadata.Builders
{
    public class MongoDbDocumentBuilder
    {
        ...
        {
            get { return MongoDbEntityTypeAnnotations.DiscriminatorIsRequired; }
            set { SetDiscriminatorIsRequired(value); }
        }

        public virtual bool IsRootType
        {
            get { return MongoDbEntityTypeAnnotations.IsRootType; }
            set { SetIsRootType(value); }
        }
        ...
        public virtual MongoDbDocumentBuilder SetDiscriminatorIsRequired(bool discriminatorIsRequired)
        {
            MongoDbEntityTypeAnnotations.DiscriminatorIsRequired = discriminatorIsRequired;
            return this;
        }

        public virtual MongoDbDocumentBuilder SetIsRootType(bool isRootType)
        {
            MongoDbEntityTypeAnnotations.IsRootType = isRootType;
            return this;
        }
