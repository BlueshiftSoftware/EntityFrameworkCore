...
namespace Blueshift.EntityFrameworkCore.MongoDB.Update
{
    ...
    public abstract class BaseWriteModelGenerator<TEntity> : IWriteModelGenerator<TEntity>
    {
        ...
        public BaseWriteModelGenerator(
        ...
        public abstract WriteModel<TEntity> GenerateWriteModel([NotNull] IUpdateEntry updateEntry);
